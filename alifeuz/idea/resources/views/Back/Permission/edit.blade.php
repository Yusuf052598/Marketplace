    ...
    <div class="am-pagebody">
        ...
        <div class="row row-sm mg-t-20">
            @if(isset($permissions))
                <form  action="{{route('permission.update')}}" method="post" class="form-control" >
                    @csrf
                    @method('PUT')
                    <div class="col-lg-12">
                        <label for="id1" >Permission<span class="tx-danger">*</span></label>
                        <input id="id1" required class="form-control" value="{{$permissions->name}}" type="text" name="name">
                    </div><!-- col-4 -->
                    <div  class="col-lg-12">
                        <label for="id" class="mt-2">Guard Name<span class="tx-danger">*</span></label>
                        <input id="id" required class="form-control" type="text" value="{{$permissions->guard_name}}" name="guard_name">
                    </div><!-- col-4 -->

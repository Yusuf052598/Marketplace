...
@section('content')
    ...
    <div class="am-pagebody">
        ...
        <div class="row row-sm mg-t-20">
            <form  action="{{route('permission.store')}}" method="post" class="form-control" >
                @csrf
                <div class="col-lg-12">
                        <label for="id1" >Permission<span class="tx-danger">*</span></label>
                        <input id="id1" required class="form-control" type="text" name="name"  placeholder="Enter Permission">
                </div><!-- col-4 -->
                <div  class="col-lg-12">

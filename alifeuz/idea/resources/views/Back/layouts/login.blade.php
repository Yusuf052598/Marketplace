...
<body>
<div class="am-signin-wrapper" style="position: relative; background-color: white;background-image: linear-gradient(to right,white,white 100%)">

...
@section('content')
    ...
    <div class="am-pagebody">
        ...
        <div class="row row-sm mg-t-20">
            <form  action="{{route('user_role.store')}}" method="post" class="form-control" >
                @csrf
                <div class="col-lg-12">
                        <label for="id1" >Role<span class="tx-danger">*</span></label>
                    <select name="role_id" id="id" class="form-control">

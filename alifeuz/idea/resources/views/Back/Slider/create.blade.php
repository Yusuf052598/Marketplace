        ...
        <div class="row row-sm mg-t-20">
            <div class="col-xl-12">
                <div class="card pd-20 pd-sm-40 form-layout form-layout-4">
                    <form id="form_modal" action="{{route('slider.store')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-sm-12 mg-t-10 mg-sm-t-0 mt-3">
                                 ...
                                 <textarea class="form-control" id="editor1" name="editor[uz]"></textarea>
                            </div>
                            <div class="col-sm-12 mg-t-10 mg-sm-t-0 mt-3">
                                    <label for="editor2" class="card-body-title">Content en</label>
                                <textarea class="form-control" id="editor2" name="editor[ru]"></textarea>
                            </div>

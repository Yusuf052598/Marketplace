    ...
    <div class="am-pagebody">
        <div class="card pd-20 pd-sm-40">
            ...
            <p class="mg-b-20 mg-sm-b-30">
                <a href="{{route('permission_user.create')}}" class="btn btn-primary">Create</a>
            </p>
                    ...
                    @if(isset($db))
                        @foreach($db as $model)
                            <tr>
                                ...
                                <td class="text-dark">{{$model->permission->name}}</td>
                                <td><i class=" fa fa-eye text-dark" style="font-size: 3vh"></i></td>
                                <td>
                                    <a href="{{route('permission_user.edit')}}">
                                        <i class="fa fa-pencil text-primary" style="font-size: 3vh"></i>
                                    </a>
                                </td>
                                <td>
                                    <a href="{{route('permission_user.delete')}}"><i class="fa fa-trash text-danger" style="font-size: 3vh"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    @endif

...
namespace App\Http\Controllers\Back\Marketplace\Products;
...
class Controller extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('Back.Marketplace.Products.index',compact('products'));
    }
    ...
    {
        $categories=MarketCategories::with('market')->where('market_id','=','8')->get();

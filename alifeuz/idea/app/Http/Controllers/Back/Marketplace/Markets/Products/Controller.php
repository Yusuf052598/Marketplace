...
namespace App\Http\Controllers\Back\Marketplace\Markets\Products;
...
class Controller extends BaseController
{
    ...
    {   $roleName = auth()->user()->getRoleNames();
        if ($roleName[0]=='super_admin_role'):
            $products=Products::with('user')->whereHas('category',function (Builder $query){
        ...
        return view('Back.Marketplace.Markets.Products.index',compact('products'));
    }
    ...
    public function select(Request $request){
        $categories=MCategories::where('market_id','=',$request->id)->get();

...
namespace App\Http\Controllers\Front\Markets;
...
class Controller extends BaseController
{
    ...
    {   $counts=Card::count();
        $sum=Card::sum();
        $markets=Markets::with('category')->take(3)->orderByDesc('id')->latest()->get();
        return view('Front.Markets.index',compact('markets','counts','sum'));
    }
    ...
    public function page(Request $request){
        ...
        $counts=Card::count();
        $sum=Card::sum();
        return view('Front.Markets.market_page',compact('products','categories','counts','sum'));
    }
    ...
    {    $counts=Card::count();
       ...
       return view('Front.Markets.product',compact('products','counts','sum'));
    }

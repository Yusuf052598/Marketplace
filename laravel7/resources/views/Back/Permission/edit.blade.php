                                ...
                                @if(isset($permissions))
                                    <form action="{{route('permission.update')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input required type="text" id="login2" name="name" value="{{$permissions->name}}" class="form-control " />
                                        </div>
                                        <div class="col-lg-6">
                                            <label for="login3" class="login3">Guard Name</label>
                                            <input required type="text" id="login3" name="guard_name" value="{{$permissions->guard_name}}" class="form-control " />
                                        </div>

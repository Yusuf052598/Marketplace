                        ...
                        <div class="sparkline13-hd">
                            <div class="main-sparkline13-hd">
                                ...
                                <div class="sparkline13-outline-icon">
                                    <span><a href="{{route('role.create')}}" class="btn btn-custon-rounded-two btn-danger">Create</a></span>
                                </div>
                            </div>
                        </div>
                                    ...
                                    @if(isset($db))
                                        @foreach($db as $model)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('role.edit',$model->id)}}" class="btn btn-white">
                                                        <i class="fa fa-pencil-square fa-2x text-info"></i>
                                                    </a>
                                                </td>
                                                <td>
                                                    <a href="{{route('role.delete',$model->id)}}" class="btn btn-white text-center">

                                ...
                                <div class="row">
                                    <form action="{{route('categories.update')}}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input required type="text" id="login2" name="name[uz]" value="{{$categories->name['uz']}}" class="form-control " />
                                        </div>
                                        <div class="col-lg-6">
                                            <input type="hidden" name="id" value="{{$categories->id}}">
                                            <label for="login3" class="login3">Name Ru</label>
                                            <input required type="text" id="login3" name="name[ru]" value="{{$categories->name['ru']}}" class="form-control " />
                                        </div>

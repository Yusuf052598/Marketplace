...
@section('content')
    <div class="advanced-form-area mg-b-15">
        ...
        <div class="container-fluid">
            <form action="{{route('market.products.store')}}" method="post" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="chosen-select-single mg-b-20">
                                        ...
                                        <select required name="market_id" id="ca_id" data-placeholder="Choose a Country..." class="chosen-select" tabindex="-1">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select required  name="category_id" id="sub_id" data-placeholder="Tanlang" class="chosen-select-single  form-control">
                                    </select>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sparkline10-graph">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select name="rec" id="body1" class="form-control">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(".chosen-select").change(function(event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{route('market.products.select')}}",

                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="sparkline12-graph">
                                    <div class="basic-login-form-ad">
                                        ...
                                        <div class="row">
                                            @if(isset($markets))
                                               <form action="{{route('market.update')}}" method="post" enctype="multipart/form-data">
                                                  @csrf
                                                  @method('PUT')
                                                <div class="col-lg-6">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <input required type="text" id="login2" value="{{$markets->name}}" name="name" class="form-control " />
                                                </div>
                                                <div class="col-lg-6">
                                                    <label class="login3" for="login3">Brand Images
                                                    </label>
                                                    <input  type="file" id="login3" name="img" class="form-control" style="padding-bottom: 30px" />
                                                </div>
                                                   <div class="col-lg-6">
                                                       <input type="hidden" name="id" value="{{$markets->id}}">
                                                   </div>
                                                   <div class="col-lg-6">
                                                       <img style="width: 100px;height: 100px" src="{{'/'.$markets->img}}" alt="">
                                                   </div>

            ...
            <ul class="nav navbar-nav left-sidebar-menu-pro">
                ...
                <li class="nav-item">
                    <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                        ...
                        <span class="mini-dn">Settings</span>
                        <span class="indicator-right-menu mini-dn">
                            <i class="fa indicator-mn fa-angle-left"></i>
                        </span>
                    </a>
                    <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                        <a href="{{route('user')}}" class="dropdown-item">Users menu</a>
                        <a href="{{route('permission')}}" class="nav-link text-dark">Permission</a>
                        <a href="{{route('role')}}" class="nav-link text-dark">Role</a>
                        <a href="{{route('permission_user')}}" class="nav-link text-dark">User Permission</a>
                        <a href="{{route('user_role')}}" class="nav-link text-dark">User Give Role</a>
                    </div>
                </li>
                @endrole
